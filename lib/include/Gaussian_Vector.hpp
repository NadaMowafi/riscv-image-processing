#ifndef GAUSSIAN_VECTOR_HPP
#define GAUSSIAN_VECTOR_HPP
...
// Applies a separable Gaussian filter to the input image (templated, compatible with scalar version)
template <typename T>
